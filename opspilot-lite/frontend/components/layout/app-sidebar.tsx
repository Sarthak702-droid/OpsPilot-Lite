...
import { LayoutDashboard, Package, Users, FileText, Truck, Siren, CheckCircle2, Sparkles, Upload, Settings, ShoppingCart, ClipboardList, CreditCard } from "lucide-react";
import type { LucideIcon } from "lucide-react";
const links: { href: string; label: string; icon: LucideIcon }[] = [
  { href: "/dashboard", label: "Overview", icon: LayoutDashboard }, { href: "/inventory", label: "Inventory", icon: Package }, { href: "/customers", label: "Customers", icon: Users }, { href: "/sales", label: "Sales", icon: ShoppingCart }, { href: "/invoices", label: "Invoices", icon: FileText }, { href: "/payments", label: "Payments", icon: CreditCard }, { href: "/suppliers", label: "Suppliers", icon: Truck }, { href: "/purchase-orders", label: "Purchase orders", icon: ClipboardList }, { href: "/signals", label: "Signals", icon: Siren }, { href: "/actions", label: "Action center", icon: CheckCircle2 }, { href: "/ask", label: "Ask OpsPilot", icon: Sparkles }, { href: "/import", label: "Import data", icon: Upload }, { href: "/settings", label: "Settings", icon: Settings },
];
